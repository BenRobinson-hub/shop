		...
		<view class="bg--w111-fff rd-24rpx pt-32 pb-32 pl-56 pr-56 mt-24" v-if="replyCon.reply">
			<view class="flex-between-center">
				<view class="flex-y-center">
					<image :src="replyCon.reply.avatar" class="w-56 h-56 rd-28rpx"></image>
			...
			<view class="reply_box pb-24" v-for="(item,index) in replyList" :key="index">
				<view class="flex justify-between items-baseline">
					<view class="flex-y-center mt-32">
						<image class="w-64 h-64 rd-50%" :src="item.user.avatar" v-if="item.uid && item.user"></image>
						<image class="w-64 h-64 rd-50%" src="../static/store.png" v-if="!item.uid"></image>
						<image class="w-64 h-64 rd-50%" src="@/static/images/f.png" v-if="!item.user"></image>
