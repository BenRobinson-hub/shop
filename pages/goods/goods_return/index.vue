			...
			<view class='apply-return'>
				...
				<view class="list">
					<view class='item textarea'>
						...
						<textarea placeholder='必填，请您详细填写备注说明' placeholder-class="placeholder" maxlength=100 name="refund_reason_wap_explain" @input="sumfontnum"></textarea>
					</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			// 最大限制金额
			replaceInput(e){
			  if(e.detail.value>=this.maxPrice){
				  setTimeout(()=>{
					this.refund_price = this.maxPrice 
				  },0)
			  }
			},
			// 限制文本框字数
