	...
	<view :style="colorStyle">
		<view class="w-full relative z-99" :style="{'padding-top': sysHeight + 'px'}">
			...
			<view class="px-20 relative z-80">
				...
				<view class="bg--w111-fff rd-24rpx p-32 relative z-1"
					v-if="[1,3].includes(orderInfo.shipping_type) && orderInfo.product_type==0">
		...
		<view class='fixed-lb bt w-full bg--w111-fff pb-safe z-80'>
			<view class="h-96 px-20 flex-y-center">
				<view class="more-box" v-if="orderInfo.type == 9 && orderInfo.shipping_type == 1 && orderInfo._status._type == 2">
