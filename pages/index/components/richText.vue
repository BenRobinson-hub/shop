...
<script>
	...
	export default {
		...
		computed: {
			...
			richTextWrapStyle() {
				return {
					'padding': `${this.dataConfig.topConfig.val}rpx ${this.dataConfig.lrConfig.val}rpx ${this.dataConfig.bottomConfig.val}rpx`,
					'margin-top': `${this.dataConfig.udConfig.val}rpx`,
