						...
						<view class="px-32">
							<view class="w-full pt-36">
								...
								<view class="fs-30 text--w111-333 fw-500 lh-42rpx"
									...
									>{{  storeInfo.title || storeInfo.store_name }}</view>
								<!-- 预售信息 -->
								...
								<view class="flex-between-center mt-20 text--w111-999 fs-22 lh-30rpx">
									<text>原价：{{ storeInfo.ot_price || storeInfo.product_price }}</text>
							...
							that.downloadFilePromotionCode(function(msgPromotionCode) {
								...
								that.$nextTick(()=>{
									setTimeout(()=>{
										...
										that.storeInfo.price, that.storeInfo.ot_price,that.posterTitle,
