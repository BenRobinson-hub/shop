        ...
        <view class="w-full relative z-99 gradient-box" :style="{ 'padding-top': sysHeight + 'px' }">
            ...
            <view class="px-20 mt-30">
                <view class="allAddress">
                    ...
                    <!-- <view class="address add1 flex-between-center" :class="[1, 2].includes(isDisplay) ? 'rd-24rpx' : 'rd-b-24rpx'" @tap="onAddress()" v-if="deliveryType == 1">
		...
		checkShipping() {
			check_shipping({
				...
				// 1：快递配送，2：到店自提，3：门店配送
				 ...
				 // if(isDisplay.indexOf('2') != -1 && isDisplay.indexOf('1') == -1){
					//  this.shippingType = 1
				 // }
